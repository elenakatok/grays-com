...
type TestArgs = { _test: { participant_id: string; game_instance_id: string } }
type TokenArgs = { token: string }
type CallArgs = TokenArgs | TestArgs

async function callFunction<T>(name: string, body: CallArgs): Promise<T> {
